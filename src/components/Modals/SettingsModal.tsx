								...
								<div className='w-[170px]'>
									<div className='relative'>
										...
										{settings.dropdownIsOpen && (
											<ul
												className='absolute mt-1 max-h-56 overflow-auto rounded-none p-2 z-50 focus:outline-none shadow-lg   w-full bg-dark-layer-1'
												style={{
...
const SettingsListItem: React.FC<SettingsListItemProps> = ({ fontSize, selectedOption, handleFontSizeChange }) => {
	return (
		<li className='relative flex h-8 cursor-pointer select-none py-1.5 pl-2 text-label-2 dark:text-dark-label-2 hover:bg-dark-fill-3 rounded-none'>
			<div
